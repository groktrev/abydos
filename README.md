...
See the Abydos [documentation](https://abydos.readthedocs.io/) for available algorithms. Algoritms requiring SyllabiPy, NLTK, PyLZSS, or paq are not implemented.
## Requirements
